...
add_wllq_by_well <- function(dat, wllq.tb.by.well.file, num_rows_per_plate, num_columns_per_plate) {
  ...
  # If there are multiple rows in wllq.tb that apply to the same well/assay,
