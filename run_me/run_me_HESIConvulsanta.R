...
dataset_title <- "HESIConvulsant2018a" # e.g. "name2020"
...
tryCatch(writeCheckSummary(main.output.dir, dataset_title), 
         error = function(e){
           ...
           e } )  
# OUTPUT --------------------------------------------------------- 
# HESIConvulsant2018a_check_summary_2021-04-26.txt is ready.
# ---------------------------------------------------------------- 
...
# ...
# HESIConvulsant2018a_dat1_2021-04-26.RData is ready.
...
# 
# Loading...
# HESIConvulsant2018a_dat1_2021-04-26.RData 
# 
...
# Treated stats file name: HESI_20180314_MW1207-15_12_01(000)_Neural Statistics Compiler(000).csv
# ...
# HESIConvulsant2018a_dat2_2021-04-26.RData is ready.
# ---------------------------------------------------------------- 
...
# -100.00  -19.76    0.00   30.04   25.39 2425.67     374 
# ---------------------------------------------------------------- 
rm(dat2)
...
# experiment date's not in calc file -> get from srcf instead
...
# 
# Loading...
# HESIConvulsant2018a_dat2_2021-04-26.RData 
# HESIConvulsant2018a_dat3_2021-04-26.RData is ready.
# ---------------------------------------------------------------- 
rm(cytodat)
...
# quick fix:
dat4[is.na(apid), apid := experiment.date]
dat4[is.na(apid)] # empty
